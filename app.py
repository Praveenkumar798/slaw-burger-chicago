...
import app_startup  # Downloads database from Cloud Storage on startup
...
# Enable CORS for duty tracker frontend
CORS(app, resources={
    r"/api/*": {
        "origins": [
            "https://daily-duties-tracker.web.app",
            "https://daily-duties-tracker.firebaseapp.com",
...
atexit.register(app_startup.sync_database_to_storage)
